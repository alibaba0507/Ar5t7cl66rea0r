...
public class OpenPoject extends javax.swing.JPanel {
                        ...
                        if (obj.equals(url)) {
                            ...
                            SwingUtilities.invokeLater(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    OpenPoject.this.spinFile = f.getParent() + ArticleManagmentMain.FILE_SEPARATOR
    ...
    public JEditorPane getSpinTextCompoent()
    {
        return this.txtSpin;
    }
    /*
    ...
    public void save() {
        ...
        ProjectsUI.reloadProjectTree(txtProjName.getText());
        InnerFramesUI.getInstance().closeFrame("New Project");
        InnerFramesUI.getInstance().ceateProjectFrame(null,null);
    }
